        ...
        <div className="container book-details-page">
            ...
            <div className="book-details-grid">
                <div className="book-cover-section">
                    <img src={book.image || book.itemImage} alt={book.title} className="detail-image" />
                </div>
                ...
                <div className="book-info-section">
                    ...
                    <div className="detail-price-box">
                        ...
                        <span className={`stock-status ${book.countInStock > 0 ? 'in-stock' : 'out-of-stock'}`}>
                            {book.countInStock > 0 ? `In Stock (${book.countInStock} items left)` : 'Out of Stock'}
                        </span>
                    </div>
